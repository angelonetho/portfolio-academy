    ...
    return (
        <BaseWindow title="Minha Coleção" variant="orange" close_to="/">
            ...
            <Paragraph>
                ...
                Eu tenho 19 anos e faço 20 em janeiro do ano que vem. Nasci em Curitiba, mas morei toda a minha vida em Paranaguá, no litoral do Paraná. Isso até eu me mudar para Curitiba com o meu irmão, que já estava na faculdade.<br/><br/>

                Mas eu vou pular essas informações que estão na minha identidade e mostrar coisas, coisas aleatórias, que eu acho da hora e que eu fiz na minha vida.<br/><br/>

                Desculpa se eu escrever muito (eu gosto de escrever bastante).
            </Paragraph>
            <Title variant="orange">Minecraft</Title>
            <Paragraph>
                Se você assistiu ao meu vídeo, ele começa falando que a minha jornada começou no Minecraft. E de fato, foi lá mesmo. Embora eu tenha expandido para outras áreas fora do jogo, eu continuei desenvolvendo para o Minecraft. <br/><br/>

                Eu era fascinado por servidores, pela experiência do multijogador. Certo dia eu bati a mão na mesa e disse: "Como assim eles conseguem fazer isso? Eu também quero fazer igual a eles." <br/><br/>

                Após muita pesquisa, eu desisti umas três vezes em um ano; parecia coisa demais para a cabeça de um pré-adolescente de 11 anos, mas uma hora deu certo. <br/><br/>

                Tem duas coisas específicas das quais eu me orgulho que envolvem o Minecraft. A primeira é que eu abria servidores; todas as férias meus amigos me chamavam e perguntavam: "Ei, vai ter servidor de Mine?". Isso me deixava muito feliz. <br/><br/>

                Essa tradição começou em 2017 e teve seu auge na pandemia, quando eu desenvolvia plugins para adicionar novas coisas ao jogo, como novos chefões, novas habilidades, novos NPCs, etc. <br/><br/>

                Por incrível que pareça, eu não jogava com eles; eu ficava conversando com eles em chamada, claro, mas dentro do jogo eu era uma entidade invisível. Eu gostava apenas de observar meus amigos se divertindo e de criar essa experiência para eles; por exemplo, eu criava eventos aleatórios de chefões, do nada, e ver a empolgação deles era a minha felicidade. <br/><br/> 
            ...
            <Paragraph>
                Como eu disse, eu moro com meu irmão mais velho, e várias coisas que a gente faz no dia a dia são juntos.<br/><br/>
            ...
            <Paragraph>
                Como eu disse no vídeo, o IFPR para mim foi um ponto de virada muito grande. Aquele lugar era estranho, e isso fazia dele perfeito.<br/><br/>

                No IFPR eu não tinha aulas normais de ensino médio que focavam em passar em vestibular; era um ambiente mais livre, que me fazia sair da minha zona de conforto e estimulava mais a minha criatividade.<br/><br/>

                Tem tanta coisa de que eu tenho orgulho de ter participado no IFPR.<br/><br/>
